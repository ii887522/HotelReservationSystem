<%@ Page Title="Hollywood Twin Room Details | RTC Hotel" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="HollywoodTwinRm.aspx.cs" Inherits="HotelReservationSystem.Room.RoomDetails.HollywoodTwinRm" %>
...
<div style="text-align:center;font-family:'Brush Script MT'";>
  ...
  <div class="carousel-inner mx-2">
    <div class="carousel-item active">
      <asp:Image runat="server" CssClass="d-block w-100" ImageUrl="~/images/hollywoodTwinRoom.jpg" Height="500px"/>
    </div>
