<%@ Page Title="Double Double Room Details | RTC Hotel" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DoubleDoubleRm.aspx.cs" Inherits="HotelReservationSystem.Room.RoomDetails.DoubleDoubleRm" %>
...
<div style="text-align:center;font-family:'Brush Script MT'";>
  ...
  <div class="carousel-inner mx-2">
    <div class="carousel-item active">
      <asp:Image runat="server" CssClass="d-block w-100" ImageUrl="~/images/doubleDoubleRoom.jpg" Height="500px"/>
    </div>
